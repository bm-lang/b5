...
abstract public class B5Num0 extends B5Expr {

  public final B5Expr left;
  public final B5Expr right;

  public B5Num0(B5Scope scope, B5Expr left, B5Expr right) {
    super(scope);
    this.left = left;
    this.right = right;
  }
  ...
  public void compile() {
    ...
    setResultingType(scope.getProgram().findBiggestNumberType(leftType, rightType));
  }
